    ...
    <section>
        <div class="card">
            ...
            <div class="card-header ">
              <a href="{{ route('hoadonban.index') }}" class="btn btn-warning">Đơn hàng chờ xét</a>
              <a href="{{ route('donhangcho') }}" class="btn btn-primary">Đơn hàng đang vận chuyển</a>
              <a href="{{ route('donhangdaban') }}" class="btn btn-danger">Đơn hàng đã giao</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              @if(session('success'))
                ...
                <tr>
                    ...
                    <td>
                      ...
                      @elseif($item->TrangThai==1)
                        <p style="color: rgb(119, 0, 255)">Đang vận chuyển</p>
                    ...
                    <td>
                      ...
                      <div class="d-flex align-items-center justify-content-center">
                        ...
                        <a onclick="return confirm('Bạn có muốn xóa không?')" href="{{ route('/admin/sanpham/delete',["id"=>$item->id]) }}" ><i style="color: red" class="fa fa-trash"></i></a>
                        </div>
                      @elseif($item->TrangThai==1)
                      <div class="d-flex align-items-center justify-content-center">
